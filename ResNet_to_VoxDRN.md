...
### 网络结构
 ...
 Gal 和 Ghahramani [*4-1] 中证明，贝叶斯CNN在小数据的过拟合上提供了更好的鲁棒性。这一网络是目的是找到后验概率(https://latex.codecogs.com/gif.latex?p(\mathbf{W}|\mathbf{X},\mathbf{Y})) 在网络中用variational dropout来解决这一问题。
